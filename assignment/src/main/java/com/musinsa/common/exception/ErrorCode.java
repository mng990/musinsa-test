...
public enum ErrorCode {
	...
	PRODUCT_DELETE_FAILED(HttpStatus.BAD_REQUEST, "상품 삭제에 실패하였습니다.", "PRODUCT-002"),
	PRODUCT_UPDATE_FAILED(HttpStatus.BAD_REQUEST, "상품 수정에 실패하였습니다.", "PRODUCT-003"),
	PRODUCT_CREATE_FAILED(HttpStatus.BAD_REQUEST, "상품 작성에 실패하였습니다.", "PRODUCT-004"),
	...
	CATEGORY_DELETE_FAILED(HttpStatus.BAD_REQUEST, "카테고리 삭제에 실패하였습니다.", "CATEGORY-002"),
	CATEGORY_UPDATE_FAILED(HttpStatus.BAD_REQUEST, "카테고리 수정에 실패하였습니다.", "CATEGORY-003"),
	CATEGORY_CREATE_FAILED(HttpStatus.BAD_REQUEST, "카테고리 작성에 실패하였습니다.", "CATEGORY-004"),
	...
	BRAND_DELETE_FAILED(HttpStatus.BAD_REQUEST, "브랜드 삭제에 실패하였습니다.", "BRAND-002"),
	BRAND_UPDATE_FAILED(HttpStatus.BAD_REQUEST, "브랜드 수정에 실패하였습니다.", "BRAND-003"),
	BRAND_CREATE_FAILED(HttpStatus.BAD_REQUEST, "브랜드 작성에 실패하였습니다.", "BRAND-004"),
